...
@Autonomous(name = "BasicAutoLeftSimple", group = "Autonomous", preselectTeleOp = "Drive")
public class BasicAutoLeftSimple extends LinearOpMode {
    private Hydra hydra;
    public void runOpMode(){
        ...
        while (opModeIsActive()) {
            switch (state){
                ...
                case 3: hydra.forwardBy(100); state = 4; break;
                case 4: break;
            }
            hydra.update();
            //hydra.forward(error);
